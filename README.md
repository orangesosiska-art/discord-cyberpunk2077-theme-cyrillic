...
# Cyberpunk 2077 Theme - Cyrillic Script Support

Changes the font of the Cyberpunk theme to support all letters of the Cyrillic script. 
...
Support the original creator, PatrykBielanin here: [![Paypal][paypal-logo]][paypal-url] [![Donate][coffe-logo]][coffe-url] [![Download][download-logo]][download-url] [![Website][website-logo]][website-url]

## Website

Website related to the original theme with configuration tool and FAQ - [cyberpunk.pbielanin.pl](https://cyberpunk.pbielanin.pl)
## Installation

Download the theme from the repo and copy files to your Better Discord/Legcord/Vencord/Shelter Themes folder. 
Legcord, Vencord and Shelter have special theme installation tools in the Settings.

## Screenshots
Before:

![ScreenShot](https://files.catbox.moe/fc5lol.png)

After:

![ScreenShot](https://files.catbox.moe/yio9ge.png)

## Feedback/Support

If you have any feedback or you need some help with the original theme, please reach out to the original developer at discord **bielak**
